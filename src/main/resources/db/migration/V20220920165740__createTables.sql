...
CREATE TABLE users (
                       ...
                       CONSTRAINT fka2xacd75xmr7vc8fa95r1qo1k FOREIGN KEY (updated_user) REFERENCES users(id)
);
...
CREATE TABLE user_roles (
                            ...
                            CONSTRAINT fk6cblub4wuvxc2kt1orkmpoqn6 FOREIGN KEY (updated_user) REFERENCES users(id),
